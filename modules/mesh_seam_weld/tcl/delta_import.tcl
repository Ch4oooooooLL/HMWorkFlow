...
proc ::MeshSeamWeld::validateAutoPlanReferences {plan} {
...
proc ::MeshSeamWeld::deleteAutoPlanMotherElements {plan} {
...
proc ::MeshSeamWeld::applyAutoPlanMoves {plan} {
...
proc ::MeshSeamWeld::applyAutoPlanDelta {plan} {
