...
def validate_request(data):
    ...
    if s["mode"]=="internal_component_plan" and (len(s["selected_node_ids"])!=1 or len(s["source_component_ids"])!=1):raise SchemaError("internal_component_plan requires exactly one selected node and one source component")
